...
piedra tienda ("we", "us", or "our") respects the privacy of all users of AnyMoney Ledger (the "App") and is committed to protecting personal information. This Privacy Policy explains how information is handled in the App.
...
We use Google Forms for inquiries. Information entered in the form is sent to Google's servers. Please refer to Google's Privacy Policy for more details:
...
All data in the App is stored on your device. Your data is protected by your device's security settings (such as screen lock). However, we cannot be held responsible for unauthorized access to data resulting from loss or theft of your device.

---

## 6. Changes to This Policy

This Privacy Policy may be revised as necessary. In the event of significant changes, users will be notified through an app update or within the App. Continued use of the App after changes have been made constitutes acceptance of the revised policy.
